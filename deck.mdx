...
<img src="blastoise.jpg" alt="Blastoise" />
...
- Usar SSR quando:
  - "First meaningful paint" for importante (para fins de UX)
  - HTML inicial precisa mudar de acordo com a rota e atender crawlsers que não executam JS (para fins de SEO)
